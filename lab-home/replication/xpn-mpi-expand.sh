...
/home/lab/src/xpn/scripts/execute/xpn.sh -s /home/lab/replication -x /tmp/expand/replication -l /work/machines_mpi -n $NL -p $REPLICATION_LEVEL preload
sleep 5
